...
public class MeasureGapJob {
    ...
    public void execute() throws Exception {
        ...
        DataStream<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>> eventStream = sensorStream
                .map(data -> {
                    try {
                ...
                .keyBy(MeasureGapJob::KeyFunction)
       ...
       /* .map(
        ...
        Pattern<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean> ,?> pattern = Pattern.<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean> >begin("start").where(
                new IterativeCondition<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>>() {
                    @Override
                    public boolean filter(Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean> value, Context<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>> ctx) throws Exception {
                        if (!value.f4.booleanValue()) {
                            return true;
                        }
                ...
                new IterativeCondition<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>>() {
                    ...
                    public boolean filter(Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean> value, Context<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>> ctx) throws Exception {
                        ...
                        for (Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean> previousEvent : ctx.getEventsForPattern("start")) {
                            if (!previousEvent.f2.getDriverId().equals(value.f2.getDriverId())) { //new follower
                                return true;
                            }
                        }
       ...
       PatternStream<Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>> tempPatternStream = CEP.pattern( eventStream, pattern);

       DataStreamSink<String> finalStream =
               tempPatternStream.select((Map<String, List< Tuple5<Driver, RaceInfo, RaceInfo, RaceInfo,Boolean>>> passingPattern) -> {


                   return "Pattern Detected:"+ ((RaceInfo)((Tuple5)passingPattern.get("first")).f2).getDriverId().toString() + "was passed by " + ((RaceInfo)((Tuple5)passingPattern.get("next")).f2).getDriverId().toString();
               }
       ).print();
        env.execute();
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        MeasureGapJob job = new MeasureGapJob(kafkaConsumer, new PrintSinkFunction<String>());
        job.execute();
    }
    ...
    static public class GapAnalysisMapper extends RichFlatMapFunction<Tuple5<Driver, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo,Boolean>, Tuple5<Driver, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo,Boolean>> {
        ...
        /** The state for the current key. */
        private Tuple5<Driver, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo,Boolean> currentSet;
        ...
        public void flatMap(Tuple5<Driver, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo,Boolean> evt, Collector<Tuple5<Driver, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo, com.mgunter.f1streamcode.RaceInfo,Boolean>> out) throws Exception {
            //Init persistent values first time thru
                ...
                leaderState = evt.f3;
            if (mgState.getDriverDetails().toString() != "Driver undefined" && followerState.getDriverDetails().toString() != "Driver undefined" && leaderState.getDriverDetails().toString() != "Driver undefined") {
                try {
